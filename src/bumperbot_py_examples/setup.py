...
setup(
    ...
    zip_safe=True,
    maintainer='meiling',
    maintainer_email='meiling@todo.todo',
 ...
 # 'simple_publisher' executable file to be compiled from
            #  bumperbot_examples.py package and execute the __main__ function from the simple_publisher python script